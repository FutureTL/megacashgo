  ...
  return (
    <div className="min-h-screen bg-white font-[var(--font-lato)]">
      ...
      <div className="flex items-center justify-center relative px-4 py-4">
        <button className="absolute left-4" onClick={() => router.push("/personal-details")}>
          <ChevronLeft size={24} className="stroke-[#020617] stroke-2" />
        </button>
        <h1 className="text-lg font-bold text-loan-text">Additional Details</h1>
      </div>
      ...
      <div className="px-4 pb-6 max-w-md mx-auto">
        ...
        <div className="mb-6">
          <p className="text-sm mb-1">
            <span className="text-loan-green font-normal">4</span>
          ...
          <div className="flex items-center justify-center gap-[7.2px]">
            ...
            <div className="flex items-center gap-[4.722px]">
              {[...Array(4)].map((_, i) => (
                <div key={i} className="w-[5px] h-[5px] rounded-full bg-black/10"></div>
              ))}
            </div>
        ...
        <div className="flex flex-col gap-[18px]">
          ...
          <div className="flex flex-col gap-1.5">
            <label className="text-sm font-semibold text-loan-text">Occupation*</label>
            <Input
          ...
          {/* Employment Status */}
          <div className="flex flex-col gap-1.5">
            <label className="text-sm font-semibold text-loan-text">Employment status*</label>
            <Select onValueChange={(value) => handleInputChange("employmentStatus", value)}>
              <SelectTrigger className="h-auto py-2.5 px-3.5 rounded-lg border-loan-border shadow-sm text-loan-gray text-[13px]">
          ...
          {/* Time in Job */}
          <div className="flex flex-col gap-1.5">
            <label className="text-sm font-semibold text-loan-text">Time in job*</label>
            <Select onValueChange={(value) => handleInputChange("timeInJob", value)}>
              <SelectTrigger className="h-auto py-2.5 px-3.5 rounded-lg border-loan-border shadow-sm text-loan-gray text-[13px]">
                <SelectValue placeholder="Select time in job" />
              </SelectTrigger>
              <SelectContent>
                <SelectItem value="less-than-3">Less than 3 months</SelectItem>
          ...
          {/* Dependants */}
          <div className="flex flex-col gap-1.5">
            <label className="text-sm font-semibold text-loan-text">Dependants*</label>
            <Select onValueChange={(value) => handleInputChange("dependants", value)}>
              <SelectTrigger className="h-auto py-2.5 px-3.5 rounded-lg border-loan-border shadow-sm text-loan-gray text-[13px]">
          ...
          {/* Living Status */}
          <div className="flex flex-col gap-1.5">
            <label className="text-sm font-semibold text-loan-text">Living status*</label>
            <Select onValueChange={(value) => handleInputChange("livingStatus", value)}>
              <SelectTrigger className="h-auto py-2.5 px-3.5 rounded-lg border-loan-border shadow-sm text-loan-gray text-[13px]">
